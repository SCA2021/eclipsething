...
class AccountTC {
	...
	assertNotNull(acct);
	assertEquals(100, acct.getBalance(), "balance should be 0");
	...
	void testTransfer() throws Exception {
	 ...
	 Account acct1 = new Checking(100);
	 Account acct2 = new Checking(100);
		
	 //make sure neither object is null
	 //make sure the balance of both is 100
	assertNotNull(acct1);
	assertNotNull(acct2);
	assertEquals(100, acct1.getBalance(), "balance should be 0");
	assertEquals(100, acct2.getBalance(), "balance should be 0");
